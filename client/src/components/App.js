...
export default class App extends React.Component {
  constructor(props) {
    ...
    this.state = {  
      ...
      userLoggedIn: window.location.search ? window.location.search.split(/[=&]/)[1] : false,
      username: window.location.search ? window.location.search.split(/[=&]/)[3].split('%20').join(' ') : 'anonymous',
      userphoto: window.location.search ? window.location.search.split('photo=')[1] : 'http://i.imgur.com/2muFGLB.jpg',
